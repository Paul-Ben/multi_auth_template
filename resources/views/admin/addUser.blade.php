...
<div>
    <main class="py-16">
        <div class="container mx-auto px-6">
            ...
            <form action="{{ route('admin.adduser') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md space-y-6">
                @csrf
                ...
                <div class="text-center pt-3">
                    <button type="submit"
                        class="bg-blue-800 text-white py-2 px-6 rounded-full text-lg font-semibold hover:bg-blue-700 transition duration-300">Add User</button>
                </div>
                </div>
            </form>
        </div>
