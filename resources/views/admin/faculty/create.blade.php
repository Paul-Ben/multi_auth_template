...
@section('content')
    <div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            <h2 class="text-2xl font-semibold mb-4">Add a Faculty</h2>
            <form action="{{route('faculty.store')}}" method="POST" class="mb-6">
                ...
                <div class="flex space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <input type="text" name="abbreviation" id="abbreviation"  class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
