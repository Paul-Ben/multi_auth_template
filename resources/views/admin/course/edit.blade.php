    ...
    <div>
        <main class="py-16">
            <div class="container mx-auto px-6">
                <h2 class="text-3xl font-bold text-center mb-8">Course Update</h2>
                ...
                <form action="{{ route('course.update', $course) }}" method="POST"
                    ...
                    <div class="border border-gray-400 p-3 rounded">
                        <h3 class="text-xl font-semibold mb-4">Course Update</h3>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <select name="faculty_id" id="faculty_id"
                                    ...
                                    <option value="{{$course->faculty_id}}">{{$course->department->faculty->name}}</option>
                            ...
                            <div>
                                ...
                                <select name="courseLevel" id="courseLevel"
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md" required>
                                    <option value="{{$course->courseLevel}}">{{$course->courseLevel}} Level</option>
                            ...
                            <div>
                                ...
                                <select name="courseCategory" id="courseCategory"
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md" required>
                                    <option value="{{$course->courseCategory}}">{{$course->courseCategory}}</option>
                            ...
                            <div>
                                <label for="courseCreditUnit" class="block text-sm font-medium text-gray-700">Credit
                                    Unit</label>
                                <input type="number" name="courseCreditUnit" id="courseCreditUnit" value="{{$course->courseCreditUnit}}"
                            ...
                            <div>
                                ...
                                <input type="text" id="appId" name="courseCode" id="applicationId"
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md" value="{{$course->courseCode}}" required>
                            </div>
                            <div>
                                <label for="courseTitle" class="block text-sm font-medium text-gray-700">Course
                                    Title</label>
                                <input type="text" name="courseTitle" id="courseTitle" value="{{$course->courseTitle}}"
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md" required>
                            </div>
                            <div>
                                <label for="courseDescription" class="block text-sm font-medium text-gray-700">Course
                                    Description</label>
                                <input type="text" name="courseDescription" id="middleName" value="{{$course->courseDescription}}"
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md">
                            </div>
                            <div>
                                <label for="gender" class="block text-sm font-medium text-gray-700">Course
                                    Lecturer</label>
                                <input type="text" name="courseLecturer" id="courseLecturer" value="{{$course->courseLecturer}}"
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md">
                            </div>
                            <div>
                                <label for="coursePrerequisites"
                                    class="block text-sm font-medium text-gray-700">Prerequisite</label>
                                <input type="text" name="coursePrerequisites" id="coursePrerequisites" value="{{$course->coursePrerequisites}}"
                                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md">
                            </div>
                        </div>
