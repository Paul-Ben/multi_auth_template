...
@section('content')
<div>
    <h1 class="text-3xl font-bold mb-8">Academic Results</h1>
                    ...
                    <table class="w-full mb-4">
                        <thead>
                            <tr class="bg-gray-200">
                                ...
                                <th class="p-2 text-left">GPA</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="p-2">WS301</td>
                                <td class="p-2">Advanced Web Simulation Techniques</td>
                                <td class="p-2">4</td>
                                <td class="p-2">A</td>
                                <td class="p-2">4.0</td>
                            </tr>
                            <tr class="bg-gray-100">
                                <td class="p-2">AI302</td>
                                <td class="p-2">Machine Learning for Web Applications</td>
                                <td class="p-2">3</td>
                                <td class="p-2">B+</td>
                                <td class="p-2">3.3</td>
                            </tr>
                            <tr>
                                <td class="p-2">CS305</td>
                                <td class="p-2">Distributed Systems</td>
                                <td class="p-2">4</td>
                                <td class="p-2">A-</td>
                                <td class="p-2">3.7</td>
                            </tr>
                            <tr class="bg-gray-100">
                                <td class="p-2">DS301</td>
                                <td class="p-2">Data Visualization</td>
                                <td class="p-2">3</td>
                                <td class="p-2">A</td>
                                <td class="p-2">4.0</td>
                            </tr>
